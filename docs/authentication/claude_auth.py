...
NOTE: This is a sanitized version with sensitive data masked
"""
...
if [ -n "$CLAUDE_API_KEY" ]; then
    ...
    echo "YOUR_API_KEY_HERE"  # MASKED - Replace with actual implementation
fi
'''
...
class EnhancedProcessManager:
    ...
    # [Additional methods _handle_message, _handle_assistant_message, etc. remain the same]
